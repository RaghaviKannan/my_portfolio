  ...
  const skills = [
    {
      name: 'HTML',
      icon:
        'https://th.bing.com/th/id/OIP.bI8KDjd8-nDvzTX_Uok7FwHaHa?w=180&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
    {
      name: 'CSS',
      icon:
        'https://th.bing.com/th/id/OIP.NccvSu6Gut1HXGwUTBKYKgHaH3?w=169&h=180&c=7&r=0&o=5&dpr=1.25&pid=1.7',
    },
    {
      name: 'JavaScript',
      icon:
        'https://th.bing.com/th/id/OIP.g1KfG8APYNeP-B_8fEd1rQHaHa?w=192&h=191&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
    {
      name: 'ReactJS',
      icon:
        'https://th.bing.com/th/id/OIP.cPh7ujRIfcHAy4kW2ADGOwHaHa?w=177&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
    {
      name: 'Bootstrap',
      icon:
        'https://th.bing.com/th/id/OIP.KTq5K5E3QeLVrm71FR0w8gHaHa?w=193&h=193&c=7&r=0&o=5&dpr=1.25&pid=1.7',
    },
    {
      name: 'Tailwind CSS',
      icon:
    ...
    },
    {
      name: 'Redux',
      icon:
        'https://th.bing.com/th/id/OIP.yvi6B33dh1qkOz22drdl5wHaHe?w=159&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
    {
      name: 'Git',
      icon:
        'https://th.bing.com/th/id/OIP.3xatIgLyHni_Wi6mE5O7kgHaHa?w=174&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
    {
      name: 'GitHub',
      icon:
        'https://th.bing.com/th/id/OIP.kjCUP06WDUMR88i5wo2SqwHaHa?w=207&h=207&c=7&r=0&o=5&dpr=1.25&pid=1.7',
    },
    {
      name: 'MySQL',
      icon:
        'https://th.bing.com/th/id/OIP.bxyBQ7zZajsePQpFcVpAfAHaHa?w=168&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
    {
      name: 'MongoDB',
      icon:
        'https://th.bing.com/th/id/OIP.JhdchOb0n1bwrlfhGqycbgHaFG?w=254&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7',
    },
  ...
  const projects = [
    {
      ...
      description: 'To manage and assign students to Teachers and maintain a dashboard.',
      image: studteach,
      url: 'https://wondrous-lokum-64d39a.netlify.app/',
    },
    {
      title: 'Meal Finder',
      description: 'To get a recipe and video of a required dish by searching with keywords.',
      image: meal,
      url: 'https://dreamy-maamoul-ba80c3.netlify.app/',
    },
    {
      title: 'QR Code Generator',
      description: 'To Generate your own QR code for given data with a given size and format.',
      image: qrimg,
    ...
    {
      title: 'Dog Facts',
      description: 'Dog lover?? Find the interesting facts about your loved ones.',
      image: dog,
      url: '', // Add your URL
    },
    {
      title: 'Anime Finder',
      description: 'To find the anime episode with the image of the scene you have.',
      image: anime,
      url: '', // Add your URL
    },
    ...
    <div className={`flex flex-col min-h-screen ${darkMode ? 'dark' : ''}`}>
      <nav className={`bg-orange-200 ${darkMode ? 'dark:bg-gray-900' : ''}`}>
        <ul className='flex justify-end lg:mr-20'>
          ...
          <button className='border bg-red-500 p-2 text-white' onClick={toggleDarkMode}>
            Darkmode
          </button>
        </ul>
      </nav>
        ...
        <div className='container mx-auto flex-1 w-full'>
          <div className='flex py-36'>
            <div className='w-full lg:w-1/2 text-center text-xl p-20'>
              ...
              <h5>
                An Ambitious learning web-developer, a quick learner, and a hard worker. I am equipped with a promising skill set with which I could effectively self-manage during independent projects, yet an excellent team player as well.🙂
              </h5>
            </div>
            <div className='w-1/2'>
      ...
      >
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 px-5'>
          {skills.map((skill, index) => (
            <div key={index} className='enlarge-on-hover flex flex-col items-center justify-center'>
              <h4>{skill.name}</h4>
      ...
      >
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 px-5'>
          {projects.map((project, index) => (
            <div key={index} className='border border-black rounded-md py-3 flex flex-col items-center'>
              <h3>{project.title}</h3>
              <img className='p-2 project' src={project.image} alt={project.title} />
              <p className='w-1/2 p-5'>{project.description}</p>
              <a className='border border-white rounded bg-blue-500 px-5 py-2 text-white' target='_blank' rel='noopener noreferrer' href={project.url}>
                Visit
              </a>
            </div>
          ))}
      ...
      >
        ...
        <div className='container flex flex-col items-center justify-center'>
          ...
          <div className='flex space-x-4'>
            ...
            <h4>LinkedIn: <a href="www.linkedin.com/in/raghavi-kannan-60a65b1a5" target="_blank" rel="noopener noreferrer" className='underline text-blue-500'>Raghavi Kannan</a></h4>
          </div>
          <div className='flex space-x-4'>
            <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' className='w-6 h-6'>
              <path stroke-linecap='round' stroke-linejoin='round' d='M10 20h4a2 2 0 002-2V6a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a2 2 0 002 2z' />
              <path stroke-linecap='round' stroke-linejoin='round' d='M15 3v2a2 2 0 01-2 2H11a2 2 0 01-2-2V3m4 2v7m0 0v7m0-7h-3m0 0H7' />
            </svg>
        ...
        <div className='flex justify-center mt-10'>
          <button className='border border-white rounded bg-red-500 px-5 py-2 text-white' onClick={downloadResume}>
            Download Resume
          </button>
        </div>
      </section>
